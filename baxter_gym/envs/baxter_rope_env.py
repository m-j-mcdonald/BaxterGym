...
from baxter_gym.util_classes.mjc_xml_utils import MUJOCO_MODEL_X_OFFSET, MUJOCO_MODEL_Z_OFFSET
...
class BaxterRopeEnv(BaxterMJCEnv):
    ...
    def randomize_rope(self, x_bounds=(-0.15, 0.25), y_bounds=(-0.7, 1.1)):
        ...
        inds = np.random.choice(range(25, 25+2*self.rope_length-1), n_folds)
        for i in inds:
